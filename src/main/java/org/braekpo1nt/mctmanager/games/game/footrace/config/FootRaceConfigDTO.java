...
record FootRaceConfigDTO(
    ...
    public static FootRaceConfigDTO fromConfig(@NotNull FootRaceConfig config) {
        return new FootRaceConfigDTO(
                ...
                config.getFinishLine() != null ? BoundingBox.from(config.getFinishLine()) : null,
                BoundingBox.from(config.getCheckpoints()),
                config.getSpectatorArea() != null ? BoundingBox.from(config.getSpectatorArea()) : null,
                BoundingBox.from(config.getGlassBarrier()),
