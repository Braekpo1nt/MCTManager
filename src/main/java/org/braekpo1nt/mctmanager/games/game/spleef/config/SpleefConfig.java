 ...
 * @param layerBlock the block that the stencil will be replaced with upon start (within the decayAreas defined by the layers) which the floors are to be made of. If this is null, dirt will be used.
