...
public class OldClockworkRound implements Listener {

    private final Main plugin;
    private final GameManager gameManager;
    private final OldClockworkGame clockworkGame;
    ...
    public OldClockworkRound(Main plugin, GameManager gameManager, OldClockworkGame clockworkGame, Location startingPosition) {
        this.plugin = plugin;
