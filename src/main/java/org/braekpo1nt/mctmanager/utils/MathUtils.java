...
public class MathUtils {
     ...
     * @param rotationIncrement the increment (in degrees) to which the rotation values (yaw and pitch) should be
     * rounded
     * @return A {@link Location} with values set to the closest number to the input value which is a multiple of the
     ...
     * @param weightedMap a map of the objects to choose from and their weights. Can't be empty. No weight can be less
     * than 1.
     ...
     * @return the wrapped version of the index. e.g. if index is 1, and size is 4, returns 1; if index is 6, and size
     * is 4, returns 1;
     */
