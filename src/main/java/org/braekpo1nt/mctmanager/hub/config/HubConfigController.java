...
public class HubConfigController extends ConfigController<HubConfigDTO> {
    ...
    @NotNull protected HubConfigDTO createDefaultConfig() {
        ...
        return new HubConfigDTO(Main.VALID_CONFIG_VERSIONS.getLast(), defaultWorld.getName(), defaultLocation, defaultLocation, defaultLocation, Collections.emptyList(), Collections.emptyList(), yLimit, durations);
    }
}
