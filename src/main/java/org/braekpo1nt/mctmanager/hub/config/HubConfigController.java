...
public class HubConfigController extends ConfigController<HubConfigDTO> {
    ...
    @NotNull protected HubConfigDTO createDefaultConfig() {
        ...
        return new HubConfigDTO(Main.VALID_CONFIG_VERSIONS.getLast(), defaultWorld.getName(), defaultLocation, defaultLocation, defaultLocation, new HubConfigDTO.PracticeDTO(Collections.emptyList(), Collections.emptyMap()), Collections.emptyList(), Collections.emptyList(), yLimit, durations);
    }
}
