...
public class EditCommand implements BrigadierSubCommand {
    ...
    public @NotNull Permissioned<CommandSourceStack> create() {
        return Permissioned.literal("edit")
                ...
                .then(Permissioned.literal("save")
                        .then(Permissioned.argument("configFile", StringArgumentType.word())
                                .suggests((this::suggestEditorConfig))
                                .executes(BrigadierAdapters.wraps(ctx -> executeSave(ctx, false)))
                                .then(Permissioned.argument("forceSave", BoolArgumentType.bool())
