...
public class MyItemTypeMock<M extends ItemMeta> implements ItemType.Typed<M> {
    ...
    protected MyItemTypeMock(NamespacedKey namespacedKey, int maxStackSize, short maxDurability,
    ...
    public static ItemType from(JsonObject jsonObject)
    {
        ...
        if (jsonObject.has(metaClassKey))
        {
            ...
            try
            {
                ...
                {
                    String metaClassType = jsonObject.get(metaClassKey).getAsString();
                    String metaClassName;
                    // Braekpo1nt start
                    if (metaClassType.equals("PotionMeta")) {
                        metaClassName = "org.braekpo1nt.inventory.meta.MyPotionMetaMock";
                    } else {
                        metaClassName =
        ...
        return new MyItemTypeMock(key, maxStackSize, maxDurability, edible, hasRecord, fuel, blockType, translationKey, metaClass);
    }
